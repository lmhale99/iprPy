...
:any:`../modules/iprPy` documentation.
...
:any:`../calcuations/index` correspond to the names of the implemented
calculations.

The methods and attributes of the Calculation class are primarily centered
around the high-throughput :any:`prepare <prepare>` step.  In particular, each
