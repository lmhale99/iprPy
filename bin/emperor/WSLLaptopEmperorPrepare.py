...
class WSLLaptopEmperorPrepare(BaseEmperorPrepare):
    """
    Emperor prepare class for personal laptop's wsl environment
    """
    ...
    def prepare_pool_15(self, debug: bool = False, **kwargs):
        ...
        # Pull out pool-specific settings if present
        max_temperature = int(kwargs.pop('max_temperature', 8000))
        ...
        # Loop from max temperature down to 50
        for temperature in range(max_temperature, 2950, -50):
...
if __name__ == "__main__":
    ...
    emperor = WSLLaptopEmperorPrepare(args.database)
