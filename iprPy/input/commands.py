...
def commands(input_dict, **kwargs):
    """
    Checks and assigns default values for lammps_command and mpi_command 
    input_dict keys 
    ...
    lammps_version -- the version of LAMMPS associated with lammps_command
    ...
    Keyword Arguments:
    lammps_command -- replacement parameter key name for 'lammps_command'
    mpi_command -- replacement parameter key name for 'mpi_command'
    lammps_version -- replacement parameter key name for 'lammps_version'
    lammps_date -- replacement parameter key name for 'lammps_date'
    """
    
    # Set default keynames
    keynames = ['lammps_command', 'mpi_command', 'lammps_version', 'lammps_date']
