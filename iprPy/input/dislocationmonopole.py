...
def dislocationmonopole(input_dict, **kwargs):
    """
    Reads in calculation parameters associated with a dislocation-monopole record.
    ...
    dislocation_content -- alternate file or content to load instead of specified 
                       dislocation_model. This is used by prepare functions.
    x_axis, y_axis, z_axis -- the orientation axes. This function only reads in
                              values from the dislocation_model.
    atomshift -- the atomic shift to apply to all atoms. This function only 
                 reads in values from the dislocation_model.
    dislocation_burgersvector -- the dislocation's Burgers vector as a 
                                 crystallographic.vector.
    dislocation_boundaryshape -- defines the shape of the boundary region.
    dislocation_boundarywidth -- defines the minimum width of the boundary 
                                 region. This term is in units of the unit 
                                 cell's a lattice parameter.
    ucell -- the unit cell system. Used here in scaling the model parameters to
             the system being explored.
    burgersvector -- the dislocation's Burgers vector as a Cartesian vector.
    boundarywidth -- defines the minimum width of the boundary region. This term
                     is in length units.
    ...
    Keyword Arguments:
    dislocation_model -- replacement parameter key name for 'dislocation_model'
    dislocation_content -- replacement parameter key name for 'dislocation_content'
    ...
    dislocation_burgersvector -- replacement parameter key name for 'dislocation_burgersvector'
    dislocation_boundaryshape -- replacement parameter key name for 'dislocation_boundaryshape'
    dislocation_boundarywidth -- replacement parameter key name for 'dislocation_boundarywidth'
    ucell -- replacement parameter key name for 'ucell'
    burgersvector -- replacement parameter key name for 'burgersvector'
    boundarywidth -- replacement parameter key name for 'boundarywidth'
    """
    
    # Set default keynames
    keynames = ['dislocation_model', 'dislocation_content', 'x_axis', 'y_axis', 'z_axis', 
                'atomshift', 'dislocation_burgersvector', 'dislocation_boundaryshape',
                'dislocation_boundarywidth', 'ucell', 'burgersvector', 'boundarywidth']
    ...
    if dislocation_model is not None:
        ...
        for key in ('atomshift', 'x_axis', 'y_axis', 'z_axis', 'dislocation_burgersvector'):
    ...
    if ucell is not None:
        ...
        dislocation_burgersvector = np.array(dislocation_burgersvector.strip().split(), dtype=float)
