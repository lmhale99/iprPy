...
class CalculationPhonon(Record):
    ...
    def buildcontent(self, script, input_dict, results_dict=None):
        ...
        run_params['size-multipliers']['a'] = [0, input_dict['a_mult']]
        run_params['size-multipliers']['b'] = [0, input_dict['b_mult']]
        run_params['size-multipliers']['c'] = [0, input_dict['c_mult']]
