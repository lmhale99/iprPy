...
class DislDi(PotentialsPropertiesSubset):
    ...
    def load_model(self, model):
        ...
        if 'dislocation-dipole' in model:
            self.exists = True

            for comp_model in model['dislocation-dipole'].aslist('compositions'):
    ...
    def build_model(self, model):
        if self.exists is True:
            model['dislocation-dipole'] = struct_model = DM()
