...
def update_tar(database_info, record=None, name=None, style=None, root_dir=None):
    """updates a stored calculation tar archive"""
    ...
    add_tar(database_info, record=record, name=name, style=style, root_dir=root_dir)