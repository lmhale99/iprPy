...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="calculation-relax-static">
    <div>
      
      <xsl:variable name="calckey" select="key"/>

      <h2>Relax static calculation results</h2>

      <ul>
        <li><b><xsl:text>UUID4: </xsl:text></b><xsl:value-of select="key"/></li>
        <li><b><xsl:text>Calculation: </xsl:text></b><a href="https://www.ctcms.nist.gov/potentials/iprPy/notebook/relax_static.html">relax_static</a></li>
