...
from .surface_energy_static_ase import surface_energy_static_ase
from ...calculation_subset import (LammpsPotential, LammpsCommands, Units,
                                   AtommanSystemLoad, LammpsMinimize,
                                   FreeSurface)

class SurfaceEnergyStaticASE(Calculation):
...
############################# Core properties #################################
    ...
    def __init__(self,
        ...
        **kwargs : any
        ...
        self.calc = surface_energy_static_ase
