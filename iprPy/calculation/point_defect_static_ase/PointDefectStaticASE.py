...
from .point_defect_static_ase import point_defect_static_ase
from ...calculation_subset import (LammpsPotential, LammpsCommands, Units,
                                   AtommanSystemLoad, AtommanSystemManipulate,
                                   LammpsMinimize, PointDefect)

class PointDefectStaticASE(Calculation):
...
############################# Core properties #################################
    ...
    def __init__(self,
        ...
        **kwargs : any
        ...
        self.calc = point_defect_static_ase
...
########################### Calculation interactions ##########################
    ...
    def calc_output_files(self) -> list:
        ...
        return [
            '*.dump',
            'min-perfect-log.lammps',
            'min-defect-log.lammps',
            'min.in',
            'init.dat',
            'perfect.dump',            
            'defect.dump',
