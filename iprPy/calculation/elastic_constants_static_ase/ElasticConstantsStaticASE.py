...
from .elastic_constants_static_ase import elastic_constants_static_ase
from ...calculation_subset import (LammpsPotential, LammpsCommands, Units,
                                   AtommanSystemLoad, AtommanSystemManipulate,
                                   LammpsMinimize)

class ElasticConstantsStaticASE(Calculation):
...
############################# Core properties #################################
    ...
    def __init__(self,
        ...
        **kwargs : any
        ...
        self.calc = elastic_constants_static_ase
