...
def viscosity_green_kubo(lammps_command:str,
    ...
    Viscosity = runningViscosity[-1] # Final Value of the integral
    ...
    results = {}
    #Data of interest
    results['viscosity_stderr'] = uc.set_in_units(0,viscosityUnitString) #There is no notion of error for the Green-Kubo Calculation Method
