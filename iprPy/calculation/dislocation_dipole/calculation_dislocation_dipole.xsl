...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="calculation-dislocation-dipole">
    <div>
      <style>
      ...
      <h2>Dislocation dipole calculation results</h2>

      <ul>
        <li><b><xsl:text>UUID4: </xsl:text></b><xsl:value-of select="key"/></li>
        <li><b><xsl:text>Calculation: </xsl:text></b><a href="https://www.ctcms.nist.gov/potentials/iprPy/notebook/dislocation_dipole.html">dislocation_dipole</a></li>
