...
def prepare(dbase, run_directory, **kwargs):
    ...
    defect_record_dict = {}
    defect_record_df = []
    for defect_record in dbase.iget_records(style='dislocation-monopole'):
    ...
    for parent_record in parent_records:
        ...
        for defect_key in defect_keys:
            ...
            calc_dict['burgers'] =              ''
            calc_dict['boundarywidth'] =        kwargs.get('boundarywidth', '')
            calc_dict['boundaryshape'] =        kwargs.get('boundaryshape', '')
            
            calc_dict['elasticconstants_model'] = ''
            calc_dict['C11'] =                  ''
            calc_dict['C22'] =                  ''
            calc_dict['C33'] =                  ''
            calc_dict['C12'] =                  ''
            ...
            calc_dict['annealtemperature'] =    kwargs.get('annealtemperature', '')
            ...
            input_dict['dislocation_model'] = DM(defect_record.content).find('dislocation-monopole')
...
def is_new(record_df, record):
    ...
    test_df = record_df[(record_df['calc_script'] ==     record_dict['calc_script']) &
                        ...
                        (record_df['dislocation_key'] == record_dict['dislocation_key'])]
