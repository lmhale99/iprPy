...
def pointdiffusion(lammps_command, system, potential, symbols, point_kwargs,
    ...
    runsteps : int, optional
        The number of integration steps to perform (default is 100000).
    ...
    mx, b = np.polyfit(times, system.natoms * msd_x, 1)
