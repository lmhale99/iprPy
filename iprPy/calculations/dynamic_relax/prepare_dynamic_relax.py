        ...
        for i in xrange(parent_dict['number_min_states']):    
            ...
            for temperature in iprPy.tools.iaslist(temperatures):
                for sizemults in iprPy.tools.iaslist(sizemultss):
                    ...
                    calc_dict['pressure_xx'] =      kwargs.get('pressure_xx', '')
                    calc_dict['pressure_yy'] =      kwargs.get('pressure_yy', '')
                    calc_dict['pressure_zz'] =      kwargs.get('pressure_zz', '')
                    calc_dict['integrator'] =       kwargs.get('integrator', '')
                    calc_dict['thermosteps'] =      kwargs.get('thermosteps', '')
                    calc_dict['dumpsteps'] =        kwargs.get('dumpsteps', '')
                    calc_dict['runsteps'] =         kwargs.get('runsteps', '')
                    calc_dict['equilsteps'] =       kwargs.get('equilsteps', '')
                    calc_dict['randomseed'] =       kwargs.get('randomseed', '')
