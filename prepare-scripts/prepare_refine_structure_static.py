...
calc_name = 'refine_structure_static'

#Get input template
template_path = 'C:/Users/lmh1/Documents/Python-packages/iprPy/iprPy/calculations/refine_structure_static/calc_files/calc_refine_structure_static.template'
with open(template_path) as template_file:
    template = template_file.read()

#Get files to copy to each calc folder
calc_files = ['C:/Users/lmh1/Documents/Python-packages/iprPy/iprPy/calculations/refine_structure_static/calc_files/calc_refine_structure_static.py',
              'C:/Users/lmh1/Documents/Python-packages/iprPy/iprPy/calculations/refine_structure_static/calc_files/cij.template']
...
for record in records:
    ...
    for i in xrange(len(record['model'].finds('minimum-atomic-system'))):    
        ...
        for strain in iprPy.prepare.iter_as_list(strain_range):
            ...
            record_variables['pressure_xx'] =           pressure_xx
            record_variables['pressure_yy'] =           pressure_yy
            record_variables['pressure_zz'] =           pressure_zz
