...
-  **symbols**: The one or three model symbols to perform the scan for.
...
-  **number_of_steps_r**: The number of interatomic spacing values, r,
   to use. Defaultvalue is 100.
-  **minimum_theta**: The minimum bond angle, theta, for the scan in
   degrees. Default value is 1.0.
-  **maximum_theta**: The maximum bond angle, theta, for the scan in
   degrees. Defaultvalue is 180.0.
-  **number_of_steps_theta**: The number of bond angle, theta, to use.
   Defaultvalue is 100.
