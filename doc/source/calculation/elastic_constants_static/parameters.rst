...
-  **sizemults**: multiplication parameters for making a supercell of
   ...
   -  ma mb mc: multipliers for each box axis. Values can be positive or
      ...
      -  na pa nb pb nc pc: negative, positive multiplier pairs for each
         box axis. The n terms must be less than or equal to zero, and
         the p terms greater than or equal to zero. This allows for
         expanding the system in both directions relative to the
         original box’s origin.
